...
const ModalManageOrderPacked = ({ isOpen, onClose, order }) => {
  const [selected, setSelected] = useState("Dikemas");
  ...
  const statusList = ["Dikemas", "Dikirim"];
  const isPaid = order?.paymentStatus === "PAID";

  const isTrackingFilled = trackingNumber.trim() !== "";
  const isStatusShipped = selected === "Dikirim";
                    ...
                    <DataList.ItemValue>
                      <Menu.Root>
                        <Menu.Trigger
                          ...
                          isDisabled={!isPaid || !isTrackingFilled}
                        >
                          <HStack spacing={2}>
                          ...
                          >
                            {statusList.map((status) => (
                              <Menu.Item
                                ...
                                disabled={!isPaid || !isTrackingFilled}
                                color="black"
                                _focus={{
                                  bg: "gray.100",
                                }}
...
export default ModalManageOrderPacked;
